...
class Home_moreProvider extends ChangeNotifier {
  ...
  void init() {
    currentProjectName = AuthManager.instance
        .getUser()!
        .projects!
        .where((element) =>
            element.id == SharedPref.instance.getValue("currentProjectId"))
        .first
        .title;
  }
  ...
  _logout(BuildContext context) {
    ...
    appRouter.pushAndPopUntil(LoginRoute(), predicate: (Route<dynamic> route) {
      return false;
    });
  }
}
