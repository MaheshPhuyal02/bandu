class Prompts{
  ...
  static const String createTask = "Add task list as needed, call addTask function for single task and addTaskList for multiple task, with title, description, created date, deadline and subTask(list of subtasks) with title, description, deadline. Don't ask too many questions just add task as needed."
  "Remember date format : " + dateFormat;
